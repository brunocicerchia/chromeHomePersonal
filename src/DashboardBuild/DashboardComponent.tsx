...
export default function DashboardComponent() {
  ...
  const alertClicked = (uri: any) => {
    setBg("background" + uri);
  };

  return (
    <div style={styles}>
      <div className={styles.dashboardMain}>
        <Button variant="primary" onClick={handleShow} className={styles.selectVideo}>
          ...
          <div className="row">
            <div className="col-md-4">
              <Card onClick={() => alertClicked(1)}>
                <Card.Img variant="top" src="background1.gif" className="wallpaperGif"/>
              </Card>
            </div>
            <div className="col-md-4">
